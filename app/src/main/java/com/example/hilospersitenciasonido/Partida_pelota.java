...
public class Partida_pelota extends ImageView {
    ...
    public Partida_pelota(Context contexto, int nivel_dificultad){
        ...
        pantalla.getSize(maneja_coord); //determinar el tamño de la pantalla

        tam_pantX=maneja_coord.x;

        tam_pantY=maneja_coord.y;

        //Contruir un layout programatico
